    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      {/* Discount section */}
        ...
        <div className="flex flex-row justify-between items-center w-full">
          ...
          {/* Experience the Future of Banking with SparkLink! */}
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        {/* gradient start */}
        <div className="absolute z-[0] w-[40%] h-[75%] top-0 pink__gradient" />
        <div className="absolute z-[1] w-[80%] h-[90%] rounded-full white__gradient bottom-40" />
        <div className="absolute z-[0] w-[50%] h-[90%] right-20 bottom-20 blue__gradient" />
        {/* gradient end */}
      </div>
